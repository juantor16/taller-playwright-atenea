...
Locator: getByText('Transferencia enviada a email175233199475717523319960051752331998264@valido.com')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Transferencia enviada a email175233199475717523319960051752331998264@valido.com')
...
@@ -37,8 +37,9 @@ setup('Generar usuario que envía dinero', async ({ page, request }) => {
