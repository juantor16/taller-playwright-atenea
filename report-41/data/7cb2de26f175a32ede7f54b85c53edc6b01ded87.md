...
Received string: "Transferencia de email1752334013819@valido.com"
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('[data-testid="descripcion-transaccion"]').first()
    9 × locator resolved to <p data-testid="descripcion-transaccion" class="MuiTypography-root MuiTypography-body1 css-wl91uy-MuiTypography-root">Transferencia de email1752334013819@valido.com</p>
      - unexpected value "Transferencia de email1752334013819@valido.com"
...
- heading "$1,255.00" [level=3]
- button "Congelar"
- heading "$1255.00" [level=6]
- heading "•••• 6309" [level=6]
- paragraph: Débito
- text: +
...
- paragraph: Transferencia de email1752334013819@valido.com
- paragraph: + 100.00
- paragraph: Transferencia de email1752334013819@valido.com
- paragraph: + 100.00
- paragraph: Transferencia de email1752334013819@valido.com
- paragraph: + 55.00
- paragraph: Cuenta activada 6309
- paragraph: + 1000.00
```
