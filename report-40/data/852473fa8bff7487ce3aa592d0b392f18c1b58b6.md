...
- Name: TC-13 Verificar que usuario reciba la transferencia
- Location: /home/runner/work/taller-playwright-atenea/taller-playwright-atenea/tests/transacciones.spec.ts:35:1
...
Locator: getByText('Transferencia de email').first()
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Transferencia de email').first()

    at /home/runner/work/taller-playwright-atenea/taller-playwright-atenea/tests/transacciones.spec.ts:37:68
```
...
- heading "$1,000.00" [level=3]
- button "Congelar"
- heading "$1000.00" [level=6]
