...
Call log:
  ...
  - waiting for locator('[data-testid="descripcion-transaccion"]').first()
    8 × locator resolved to <p data-testid="descripcion-transaccion" class="MuiTypography-root MuiTypography-body1 css-wl91uy-MuiTypography-root">Transferencia de email1752333725349@valido.com</p>
...
- heading "$1,080.00" [level=3]
- button "Congelar"
- heading "$1080.00" [level=6]
