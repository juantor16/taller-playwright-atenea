...
Received string: "Transferencia de email1752333725349@valido.com"
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('[data-testid="descripcion-transaccion"]').first()
    9 × locator resolved to <p data-testid="descripcion-transaccion" class="MuiTypography-root MuiTypography-body1 css-wl91uy-MuiTypography-root">Transferencia de email1752333725349@valido.com</p>
      - unexpected value "Transferencia de email1752333725349@valido.com"
...
- heading "$1,257.00" [level=3]
- button "Congelar"
- heading "$1257.00" [level=6]
- heading "•••• 3661" [level=6]
- paragraph: Débito
- text: +
...
- paragraph: Transferencia de email1752333725349@valido.com
- paragraph: + 77.00
- paragraph: Transferencia de email1752333725349@valido.com
- paragraph: + 100.00
- paragraph: Transferencia de email1752333725349@valido.com
- paragraph: + 80.00
- paragraph: Cuenta activada 3661
- paragraph: + 1000.00
```
