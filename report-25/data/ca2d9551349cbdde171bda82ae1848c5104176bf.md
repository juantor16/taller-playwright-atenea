...
- Location: /home/runner/work/taller-playwright-atenea/taller-playwright-atenea/tests/transacciones.spec.ts:34:1
...
Call log:
  ...
  - waiting for getByText('Transferencia de email').first()
    ...
    at /home/runner/work/taller-playwright-atenea/taller-playwright-atenea/tests/transacciones.spec.ts:36:68
```
...
- heading "2/7/2025" [level=6]
- paragraph: Cuenta activada 6624
- paragraph: + 1000.00
```
...
```ts
  ...
  21 | })
  22 |
  23 | testUsuarioEnvia('TC-12 Verificar transacción exitosa', async ({ page }) => {
...
@@ -30,10 +30,15 @@ setup('Generar usuario que envía dinero', async ({ page, request }) => {
